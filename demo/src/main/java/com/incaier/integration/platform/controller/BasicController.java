...
public class BasicController {
    ...
    @ResponseBody
    public PageInfo<Personnel> hello(@RequestParam(name = "id") Integer id,
                                     @RequestParam(name = "pageNum") Integer pageNum,
                                     @RequestParam(name = "pageSize") Integer pageSize) {
        redisTemplate.opsForValue().set("id", id, 1, TimeUnit.HOURS);
        return personnelService.getPersonnelInfo(id, pageNum, pageSize);
    }
